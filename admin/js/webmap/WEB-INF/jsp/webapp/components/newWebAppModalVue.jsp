...
<div class="popup newLayer" style="display:none; width:900px;" v-bind:style="styleObj" id="newWebAppModal">
    <!--head-->
    <div class="head blue">
        <strong class="titPop">새 웹앱</strong>
        <div class="btnGroup">
            ...
            <div class="table">
                <table>
                    ...
                    <tr>
                        ...
                        <td><input type="text" id="appTitleInput" ref="appTitleInput" style="width:100%;"/></td>
                    </tr>
                    <tr>
                        <th scope="row"><span class="redDot"></span>설명</th>
                        <td><textarea ref="appCnTextarea" id="appCnTextarea" style="width:100%;height:66px;"></textarea></td>
                    </tr>
                    <tr>
                        <th scope="row">썸네일</th>
                        <td>
