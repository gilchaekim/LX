...
<div class="popup" style="width:900px; display:none" v-bind:style="styleObj" id="webMapDetailModal">
    <!--head-->
    <div class="head">
        <strong class="titPop">웹맵 상세정보</strong>
        <div class="btnGroup">
    ...
    <div class="cont">
        <div class="inner cScroll" style="max-height:650px;">
            ...
            <div class="tabContWrap type04">
                ...
                <!--//tabNav-->
                <!--상세정보 탭-->
                <%@ include file="/WEB-INF/jsp/webmap/components/detailInfoTab.jsp" %>
                <!--공유현황 탭-->
                <%@ include file="/WEB-INF/jsp/webmap/components/shareInfoTab.jsp" %>
            </div>
            <!--//tabContWrap-->
        </div>
    </div>
